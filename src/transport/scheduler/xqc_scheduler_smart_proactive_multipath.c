...
#include "src/transport/scheduler/xqc_scheduler_smart_proactive_multipath.h"
#include "src/transport/scheduler/xqc_scheduler_common.h"
#include "src/transport/xqc_send_ctl.h"


static size_t
xqc_smart_proactive_multipath_scheduler_size()
{
    return 0;
}

static void
xqc_smart_proactive_multipath_scheduler_init(void *scheduler, xqc_log_t *log, xqc_scheduler_params_t *param)
{
    return;
}

xqc_path_ctx_t *
xqc_smart_proactive_multipath_scheduler_get_path(void *scheduler,
    ...
    xqc_bool_t *cc_blocked)
{
    ...
    xqc_log(conn->log, XQC_LOG_INFO, " | DEBUG: %d ", (int)packet_out->po_qos_level);
...
const xqc_scheduler_callback_t xqc_smart_proactive_multipath_scheduler_cb = {
    .xqc_scheduler_size             = xqc_smart_proactive_multipath_scheduler_size,
    .xqc_scheduler_init             = xqc_smart_proactive_multipath_scheduler_init,
    .xqc_scheduler_get_path         = xqc_smart_proactive_multipath_scheduler_get_path,
};